...
public class ArticleService {
    ...
    public void publish(PublishParam publishParam) throws BusinessException {
        ...
        Asserts.isTrue(publishParam.getAbstracts().length() > 200, ArticleError.ARTICLE_ABSTRACT_GREAT_200);
        Article article = articleAssembler.assembleArticle(publishParam);
        //防刷的问题
        this.articleDao.insert(article);
    }

    public PagerResult<AbstractArticleVO> userArticleList(UserArticleQuery userArticleQuery) {
